...
import styles from './RotatingNavigationAnimation.module.scss';
    ...
    <>
      <div
        className={`${styles.container} ${
          isOpen && styles.container__show_nav
        }`}
      >
        <div className={styles.circle_container}>
          <div className={styles.circle_container__circle}>
            <button
              id="close"
              type="button"
              className={`${isOpen ? styles.open : styles.close} ${styles.btn}`}
              onClick={handleClick}
            >
      ...
      <nav className={styles.nav}>
        <ul>
          <li className={`${isOpen && styles.text_open}`}>
            <FontAwesomeIcon icon={faHome} className={styles.nav_icon} />
            <a className={`${isOpen && styles.black}`} href="/">
              Home
            </a>
          </li>
          <li className={`${isOpen && styles.text_open}`}>
            <FontAwesomeIcon icon={faUserAlt} className={styles.nav_icon} />
            <a className={`${isOpen && styles.black}`} href="/">
              About
            </a>
          </li>
